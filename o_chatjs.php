...
if(jquery_included) {
	document.getElementById('o_chat_jquery').onload = function() {
		load_javascripts();
	}
} else {
	load_javascripts();
...
function load_javascripts() {
	var chatjs = document.createElement('script');
		...
		chatjs.src = '<?php base(); ?>js/chat.js.php?me=<?=$_GET['me'];?>&role=<?=$_GET['role']; ?>';
	...
	var chatbarjs = document.createElement('script');
		...
		chatbarjs.src = '<?php base(); ?>js/chatbar.js.php?me=<?=$_GET['me'];?>&role=<?=$_GET['role'];?>';
